  ...
  return (
    ...
    >
      ...
      <img
        src="../logo.jpeg"
        alt="Logo"
        className="absolute top-5 left-5 h-16 w-16 rounded-full shadow-lg"
      />

      <div className="flex flex-col items-center mt-10 space-y-24">
        <span className="text-4xl font-semibold bg-black text-white w-full text-center py-3 bg-opacity-75 rounded-2xl">
          Dhamm.AI
        </span>
